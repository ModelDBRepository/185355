...
#define usetable usetable_ih
 ...
 "ghyfbar_ih", "mho/cm2",
 "ghysbar_ih", "mho/cm2",
 "ghyhtfbar_ih", "mho/cm2",
 "ghyhtsbar_ih", "mho/cm2",
 "ghyf_ih", "mho/cm2",
 "ghys_ih", "mho/cm2",
 "ghyhtf_ih", "mho/cm2",
 "ghyhts_ih", "mho/cm2",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 11, "hyhts_ion");
 	...
 	ivoc_help("help ?1 ih /home/hines/tmp/hack/185355/HCN.mod\n");
...
static int _reset;
static char *modelname = "HCN channel (hyperpolarization-activated [cyclic nucleotide-gated] cation channel)";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/hines/tmp/hack/185355/HCN.mod";
static const char* nmodl_file_text = 
