...
#define nrn_init _nrn_init__NetStim125
#define _nrn_initial _nrn_initial__NetStim125
#define nrn_cur _nrn_cur__NetStim125
#define _nrn_current _nrn_current__NetStim125
#define nrn_jacob _nrn_jacob__NetStim125
#define nrn_state _nrn_state__NetStim125
#define _net_receive _net_receive__NetStim125 
#define init_sequence init_sequence__NetStim125 
#define next_invl next_invl__NetStim125 
#define noiseFromRandom noiseFromRandom__NetStim125 
#define seed seed__NetStim125 
...
#define forcestop _p[3]
#define forcestop_columnindex 3
#define noise _p[4]
#define noise_columnindex 4
#define event _p[5]
#define event_columnindex 5
#define on _p[6]
#define on_columnindex 6
#define ispike _p[7]
#define ispike_columnindex 7
#define v _p[8]
...
#define erand erand_NetStim125
#define invl invl_NetStim125
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NetStim125 /home/hines/tmp/hack/185355/netstim125.mod\n");
...
{  double* _p; Datum* _ppvar; Datum* _thread; NrnThread* _nt;
 ...
 _tsav = t;   if (_lflag == 1. ) {*(_tqitem) = 0;}
 {
   ...
   if ( _lflag  == 1.0  && on  == 1.0  && t < forcestop ) {
     ispike = ispike + 1.0 ;
     net_event ( _pnt, t ) ;
     next_invl ( _threadargs_ ) ;
     if ( on  == 1.0 ) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/hines/tmp/hack/185355/netstim125.mod";
static const char* nmodl_file_text = 
