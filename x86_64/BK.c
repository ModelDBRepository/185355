...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 bk /home/hines/tmp/hack/185355/BK.mod\n");
...
static int _reset;
static char *modelname = "BK channel (big conductance, calcium-activated potassium channel)";
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  state();
 if(error){fprintf(stderr,"at line 83 in file BK.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/hines/tmp/hack/185355/BK.mod";
static const char* nmodl_file_text = 
